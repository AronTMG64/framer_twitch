...
const Wireframe = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-gray-500 h-8 w-24"></div>
      <div className="bg-gray-500 h-8 w-24"></div>
      <div className="bg-gray-500 h-8 w-24"></div>
      <div className="bg-gray-500 h-8 w-24"></div>
      <div className="bg-gray-500 h-8 w-24"></div>
      ...
      <div className="flex flex-1">
        <div className="w-1/6 bg-gray-600 text-white">
          <div className="p-4">
            <motion.div whileHover={{height: 150}} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{height: 150}} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{height: 150}} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{height: 150}} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{height: 150}} className="bg-gray-700 h-8 mb-4"></motion.div>
        ...
        <div className="w-5/6 ">
          ...
          {Array.from(Array(40)).map((_, index) => (
              <React.Fragment key={index}>
                <motion.div whileHover={{ scale: 1.2 }} className='flex items-center justify-center flex-col mb-10'>
